...
struct SymbolSwitcherKeyView: View {
    ...
    var body: some View {
        ZStack{
            ...
            HStack {
                Text(environment.listType != .symbol2 ? "#+=" : "123")
    ...
    func defaultKeyAction() -> Void{
        if(environment.listType == .symbol1) {
            environment.listType = .symbol2
        } else {
...
struct SymbolSwitcherKeyView_Previews: PreviewProvider {
